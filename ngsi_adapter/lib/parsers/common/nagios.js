...
// Nagios base parser object (to be extended by probe-specific parsers)
var nagiosParser = Object.create(baseParser);


// Extract data and optional performance data from request body
// Base format (see http://nagios.sourceforge.net/docs/3_0/pluginapi.html):
