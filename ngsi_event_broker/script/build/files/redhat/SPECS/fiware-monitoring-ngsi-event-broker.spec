...
URL: https://github.com/telefonicaid/fiware-monitoring/tree/custom/xifi/ngsi_event_broker
Name: %{_name}
Version: %{_version}
Release: %{_release}
License: Apache
...
if [ $1 -eq 1 ]; then
	...
	fmt --width=${COLUMNS:-$(tput cols)} <<-EOF
		...
		section at /usr/share/doc/%{_name}-%{_version}/README.md
		for more details.
...
%changelog
* Fri Mar 13 2015 Telefónica I+D <opensource@tid.es> 1.3.2-1
- Include .rpm package generation
