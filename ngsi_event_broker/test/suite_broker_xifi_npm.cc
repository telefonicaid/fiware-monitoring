...
{
	if (full_command) {
		*full_command = (BrokerXifiNpmTest::__output_get_raw_command_line_r) ?
			strdup(BrokerXifiNpmTest::__output_get_raw_command_line_r) :
			NULL;
	}
...
///
int BrokerXifiNpmTest::init_module_variables(const string& args)
{
...
///
int BrokerXifiNpmTest::free_module_variables()
{
